...
[![AntV G2 Contributor](https://img.shields.io/endpoint?url=https://awards.antv.vision/afkdsghk211331-g2-contributor.json)](https://github.com/antvis/g2)
...
[![Frontend Developer](https://img.shields.io/badge/Frontend-Developer-61DAFB?style=flat&logo=react&logoColor=white)](#)
...
public:
    void getCurrentFocus() {
        cout << "🔭 Working on data visualization with AntV G2" << endl;
        cout << "🌱 Learning advanced C++ and modern frontend frameworks" << endl;
        cout << "⚡ Building efficient and beautiful applications" << endl;
    }
};
```
...
![AntV](https://img.shields.io/badge/AntV-1890FF?style=for-the-badge&logo=ant-design&logoColor=white)
